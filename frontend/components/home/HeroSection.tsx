...
import DemoPitches from "./DemoPitches";
...
function HeroSection() {
  ...
  useEffect(() => {
    leftX.on("change", (e) => {
      console.log("targetX", e);
    });
    scrollYProgress.on("change", (e) => {
      console.log(e);
    });
  }, [scrollYProgress, leftX]);

  return (
    <div className="min-w-[100%] min-h-screen overflow-y-scroll scrollbar-hidden">
      <div className="relative h-[200vh] overflow-hidden" ref={containerRef}>
        <div className="w-full h-screen flex items-center justify-center">
          <motion.div
            className={`fixed left-0 top-0 w-[50%] h-[100vh] flex flex-col  z-20 bg-black`}
            style={{ x: leftX }}
          >
            ...
            ><span className="bg-gradient-to-b from-green-800  to-white/60 bg-clip-text text-transparent pl-4  ">Con <br/></span>Pitch</motion.h1>
          </motion.div>
          <motion.div
            className="fixed right-0 top-0 w-[50%] h-[100vh] flex flex-col  z-20  bg-black "
            style={{ x: rightX }}
          >
         ...
         <div className={` w-full h-[100vh] flex flex-col items-center justify-center text-center px-6`}>
          <div className="max-w-4xl w-full">
            ...
            <p className="mt-4 text-sm sm:text-base md:text-lg text-neutral-400 max-w-3xl mx-auto">
          ...
          Get Started — It&apos;s Free
              ...
              <a
          href="#templates"
          className="inline-flex items-center justify-center px-6 py-3 border border-white/20 text-white rounded-md text-sm"
              >Browse Templates
              </a>
            </div>
          </div>
